...
table.insert(g_items, 	{
		...
		spawn_check = function() 
			local keyg = GlobalsGetValue("vaultkeygenerated", "0")
			if keyg == "0" then
				GlobalsSetValue("vaultkeygenerated", 1)
				if Portal_Key_Debug == 1 then GamePrint("One Key Generated (Vault, g_item)")	end
				return true
			else
